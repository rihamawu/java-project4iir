...
public class OrganizationManagementTabController {
    ...
    private void handleCreateOrganization(PopUpDialog popUpDialog) {
        if (popUpDialog.validateForm()) {
            ...
            globalControllersGetter.organizationsController.createOrganization(organization);
            view.refreshTable();
    ...
    private void handleEditOrganization(PopUpDialog popUpDialog) {
        if (popUpDialog.validateForm()) {
            ...
            globalControllersGetter.organizationsController.editOrganization(popUpDialog.getId(), organization);
            view.refreshTable();
    ...
    public void handleDeleteOrganization(OrganizationManagementTab.ButtonEditor editor) {
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            globalControllersGetter.organizationsController.deleteOrganization(editor.getId());
            view.refreshTable();
        }
    }
}