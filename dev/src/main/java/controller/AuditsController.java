...
import model.audit.StatRequirement;
...
public class AuditsController {
    private static final String AUDITS_FILE_PATH = FileHandler.AUDITS_FILE;
    ...
    public void loadAudits() {
        try {
            List<Audit> loadedAudits = FileHandler.loadDataFromJson(AUDITS_FILE_PATH, new TypeReference<List<Audit>>() {
            });
    ...
    public void saveAudits() {
        try {
            FileHandler.saveDataInJson(AUDITS_FILE_PATH, audits);
    ...
    public void createAudit(Audit auditData) throws Exception{
        globalControllersGetter.organizationsController.getManagementSystemById(auditData.getIdOrganization(),auditData.getIdSystemManagement());
        globalControllersGetter.accountsController.getAuditorById(auditData.getIdAuditor());
    ...
    public boolean editAudit(String id, Audit updatedAudit) throws Exception{
        globalControllersGetter.organizationsController.getManagementSystemById(updatedAudit.getIdOrganization(),updatedAudit.getIdSystemManagement());
        globalControllersGetter.accountsController.getAuditorById(updatedAudit.getIdAuditor());
    ...
    public boolean addRequirementStatToAudit(String idAudit, StatRequirement statRequirement) {
        Audit audit = getAuditById(idAudit);
        if (audit != null) {
            audit.getRequirementsStat().add(statRequirement);
            saveAudits();
