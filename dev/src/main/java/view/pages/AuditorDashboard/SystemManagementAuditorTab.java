...
public class SystemManagementAuditorTab extends JPanel {

    private List<ManagementSystem> data;
    private DefaultTableModel model;
    private JTable managementSystemTable;

    public SystemManagementAuditorTab() {
    ...
    private void setUpUi() {
        ...
        Object[][] tableData = ToObjectUtility.convertToTableData(data, columnNames);
    ...
    public static void main(String[] args) {
        ...
        SystemManagementAuditorTab systemManagementAuditorTab = new SystemManagementAuditorTab();
        frame.add(systemManagementAuditorTab);
