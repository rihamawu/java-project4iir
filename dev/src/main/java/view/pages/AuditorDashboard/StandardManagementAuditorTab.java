...
public class StandardManagementAuditorTab extends JPanel {

    private List<Standard> data = globalControllersGetter.organizationsController.getAllStandards();
    ...
    public StandardManagementAuditorTab() {
    ...
    public static void main(String[] args) {
        ...
        StandardManagementAuditorTab standardManagementAuditorTab = new StandardManagementAuditorTab();
        frame.add(standardManagementAuditorTab);
