...
public class AuditsManagementAuditorTab extends JPanel {

    private List<Audit> data;
    private DefaultTableModel model;
    private JTable auditsTable;

    public AuditsManagementAuditorTab() {
            ...
            public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
                ...
                viewDetailsButton.addActionListener(e -> {
                    ...
                    if (selectedRow != -1) {
                        ...
                        AuditDetailsDialog dialog = new AuditDetailsDialog((JFrame) SwingUtilities.getWindowAncestor(AuditsManagementAuditorTab.this), idAudit);
    ...
    public static void main(String[] args) {
        ...
        AuditsManagementAuditorTab auditsManagementAuditorTab = new AuditsManagementAuditorTab();
        frame.add(auditsManagementAuditorTab);
